...
def display_connect_page():
    ...
    with col2:
        ...
        **Stay informed** about new features and releases.
        ...
        social_links = [
            ("🐙 GitHub", "https://github.com/vatsalvarshney", "View my projects and code"),
            ("💼 LinkedIn", "https://linkedin.com/in/vatsalvarshney", "Connect professionally"),
            ("🐦 Twitter", "https://twitter.com/vatsalvarshney", "Follow me for updates"),
            ("📧 Email", "mailto:vatsal@example.com", "Send me a direct email"),
