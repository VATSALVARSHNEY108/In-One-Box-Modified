...
class AIClient:
    ...
    def generate_text(self, prompt: str, model: str = "gemini", max_tokens: int = 1000) -> str:
        ...
        try:
            if model == "gemini" and self.gemini_client:
                ...
                return "Gemini model not available. Please check your GOOGLE_API_KEY."
    ...
    def analyze_image(self, image_data: bytes, prompt: str = "Analyze this image") -> str:
        ...
        try:
            if self.gemini_client:
                ...
                return "Image analysis only available with Gemini. Please check your GOOGLE_API_KEY."
    ...
    def analyze_sentiment(self, text: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"error": "Sentiment analysis only available with Gemini. Please check your GOOGLE_API_KEY."}
